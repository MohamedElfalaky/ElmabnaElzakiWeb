...
List whyZahSoftMobile = [
  {"name": "تحليل احتياجات المنشأة بعناية", "pic": "assets/1.png"},
  {"name": "رفع الكفاءة الإنتاجية", "pic": "assets/2.png"},
  {"name": "أتمتتة المهام", "pic": "assets/3.png"},
  {"name": "التحسين من جودة الاتصال", "pic": "assets/4.png"},
  {"name": "نطبق منهجية أجايل ١٠٠٪", "pic": "assets/5.png"},
  {"name": "المزيد من الأمان", "pic": "assets/6.png"},
  {"name": "سرعة أداء عاملين المنشأة", "pic": "assets/7.png"},
  {"name": "تواجد رقمي دائم", "pic": "assets/8.png"},
  {"name": "فريق برمجي متكامل", "pic": "assets/9.png"},
  {"name": "إتفاقية سرية المعلومات", "pic": "assets/10.png"},
  {"name": "تحليل احتياجية المنشأة بعناية", "pic": "assets/11.png"},
  {"name": "رفع الكفاءة الإنتاجية", "pic": "assets/12.png"},
];
