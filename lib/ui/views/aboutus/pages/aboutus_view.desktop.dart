    ...
    return Scaffold(
      body: Directionality(
        ...
        child: Center(
          child: Column(
            children: [
              const CustomHeader(currentPage: "من نحن"),
              Expanded(
                child: SizedBox(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                  flex: 1,
                                  child: Image.asset("assets/resalatna.png")),
                            ],
                          ),
                        ),
                        verticalSpaceMassive,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                  flex: 1,
                                  child: Image.asset("assets/hadafna.png")),
                              horizontalSpaceLarge,
                              Expanded(
                                flex: 1,
                                child: Column(
