...
class AboutItemFeatures extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          Text(
            ...
            style: ktsTitleText.copyWith(
                fontSize: 17, fontWeight: FontWeight.w100, color: Colors.grey),
    ...
    return Column(
      ...
      children: [
        _aboutItemFeatures("نطبق نظام أجايل لإدارة المشروعات"),
        verticalSpaceTiny,
        ...
        verticalSpaceTiny,
        _aboutItemFeatures("برمجة نظم ERP حسب إحتياج المنشأة"),
      ],
    );
  }
}
